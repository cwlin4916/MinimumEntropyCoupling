# In this code we will implement a transformer model for sequence to sequence learning
#our goal is to to implement a transformer model which learns a joint distribution of two random variables given its marginal distributions 
# the input sequences are two matrices of shape 1 xm and 1xn. 

# we will first import some libraries
...
logger = getLogger()
#Our transformer will contain the following components; 
...
# Positional encoding
# The positional encoding is added to the input embeddings at the input layer. 
...
# we will implement the multi-head attention mechanism as a module.
#copy paste first Francoise 
